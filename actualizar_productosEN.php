            ...
            <div class="container">
                ...
                <div class="nav-collapse collapse pull-right">
                    <ul class="nav" id="top-navigation">
                        <li><a href="productsEN.php">Go back</a></li>
                    </ul>
                </div>
                <!-- End main navigation -->
            </div>
    ...
    <div class="section secondary-section " id="portfolio">
        ...
        <div class="container">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="formAccountSettings" method="POST" action="editar_productoEN.php"
                        ...
                        <div class="row2">
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="talla" class="form-label">Size</label>
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="imagen" class="form-label">Choose an image</label>

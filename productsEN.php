    ...
    <section class="section secondary-section " id="portfolio">
        ...
        <div class="container">
            ...
            <div class="pb-4 border-top-0 bg-transparent text-end">
                <a class="btn btn-info me-2" href="insertar_productoEN.php">Add products</a>
            </div>
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                if ($resultado->num_rows > 0) {
                    while ($fila = $resultado->fetch_assoc()) {
                        ...
                        echo "<a class='btn btn-primary me-2' href='actualizar_productosEN.php?id=" . $fila['id_p'] . "'>Edit product</a>";
                        echo "<a class='btn btn-danger' href='eliminar_productoEN.php?id=" . $fila['id_p'] . "'>Delete</a>";
                        echo "</div>";
                        echo "</div>";
                        echo "</div>";
                    }
